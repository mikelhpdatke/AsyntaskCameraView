package com.example.luong.asyntaskcameraview;
...
public class AsynCamPreview extends Asyncam 
	...
	static {
		...
		Log.e(TAG, "Native library loaded");
	}
	private class ProcessPreviewDataTask extends AsyncTask<byte[], Void, Boolean> {
		...
		protected Boolean doInBackground(byte[]... datas) {
			// TODO Auto-generated method stub
			Log.e(TAG, "background process started");
			byte[] data = datas[0];
			...
			Log.e(TAG, "processing time = " + String.valueOf(t2 - t1));
			
			mCamera.addCallbackBuffer(data);
			mProcessInProgress = false;
			Log.e(TAG, "doInBackground "+String.valueOf(isCancelled()));
			return true;
		}
